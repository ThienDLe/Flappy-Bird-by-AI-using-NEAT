...
pipe_img = pygame.transform.scale2x(pygame.image.load(os.path.join(
    "/Users/lethien/Desktop/Projects/Flappy Bird by AI with NEAT/assets", "pipe.png")).convert_alpha())
bg_img = pygame.transform.scale(pygame.image.load(os.path.join(
    "/Users/lethien/Desktop/Projects/Flappy Bird by AI with NEAT/assets", "bg.png")).convert_alpha(), (600, 900))
bird_images = [pygame.transform.scale2x(pygame.image.load(os.path.join(
    "/Users/lethien/Desktop/Projects/Flappy Bird by AI with NEAT/assets", "bird" + str(x) + ".png"))) for x in range(1, 4)]
base_img = pygame.transform.scale2x(pygame.image.load(os.path.join(
    "/Users/lethien/Desktop/Projects/Flappy Bird by AI with NEAT/assets", "base.png")).convert_alpha())
